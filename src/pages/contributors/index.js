      ...
      <div className="area">
        <div className="container">
          ...
          <div className="flex flex-wrap md:flex-row-reverse">
            ...
            <div className="w-full md:w-2/3 leading-9 pr-8 text-justify">
              ...
              farmer. In addition to the main work, he did all sorts of things.
              He reclaimed land for farming of rice, raising livestock, making
              wine, making vermicelli, making noodles, cutting hair, repairing
              bicycles, building houses, etc. My mother was also a teacher, and
              she also did all sorts of things after working in the school. She
              made herbal medicine, was a tutor, sold things for money, etc. My
              parents always support each other in living life. I followed my
              father and mother in most of their activities. I experienced and
              learned many interesting things from them. I went to university,
              went to work, then studied abroad and worked in Japan from 2026 to
              2020. I participated in many practical activities in Japan, too. I
              experienced growing rice, growing potatoes, growing vegetables,
              cooking, making pies, processing meat and fish, outdoor camping,
              fire extinguisher, etc. I also experienced working as an IT
              project manager, a researcher in IT, psychology and education, a
              lecturer in Ritsumeikan University., a helper and supporter for
              Vietnamese Association group in Japan.
            </div>
          </div>
          <div className="row justify-center pt-20">
            <div className="col-xl-12 col-lg-7 col-md-10 col-sm-10">
              ...
              <div className="text-left pb-5">
                ...
                <div className="">Email: Kucger07@gmail.com</div>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap">
            ...
            <div className="w-full md:w-2/3 leading-9 text-justify">
