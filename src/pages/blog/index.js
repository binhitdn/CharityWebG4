  ...
  const blogs = [
    {
      ...
      image:
        "https://cdn.thuvienphapluat.vn//uploads/tintuc/2022/09/28/lam-tu-thien.jpg",
    ...
    },
    {
      ...
      image:
        "https://image.phunuonline.com.vn/news/2019/20191205/fckimage/170729_1534422012-0db4a0i-41539828.jpg",
    ...
    },
    {
      ...
      image:
        "https://cdn1.tuoitre.vn/zoom/600_315/2020/7/4/12anh-5-1read-only-1593873889223849228767-crop-15938739906741442871616.jpg",
      categories: ["Charity", "Community"],
      comments: 10,
      date: "20 Jan",
    },
    {
      ...
      image:
        "https://static.kinhtedothi.vn/images/upload/2021/12/22/93e890d4-ae83-4f6a-bf97-5c4637ee8634.jpg",
      categories: ["Charity", "Community"],
      comments: 6,
      date: "22 Jan",
    },
    {
      ...
      image:
        "https://morningstarcenter.net/upload/user/nam%202020/img_2119.jpg",
    ...
    },
    {
      ...
      image:
        "https://photo-cms-vovworld.zadn.vn/w500/Uploaded/vovworld/ovunhuo/2022_11_29/c8_TKYP.jpg",
    ...
    <article className="bg-white shadow-md rounded-md overflow-hidden">
      ...
      <div className="blog_details p-4">
        ...
        <ul className="blog-info-link text-sm text-gray-500 flex space-x-2">
          ...
          <li>
            <a href="#" className="flex items-center">
              <i className="fa fa-comments mr-1"></i> {blog.comments} Comments
            </a>
          </li>
        </ul>
      </div>
