      ...
      <section className="dark:bg-green-400 dark:text-gray-100">
        <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
          ...
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">What is a Payment Gateway?</summary>
            ...
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">Do I need to pay to Instapay even when there is no transaction going on in my business?</summary>
              <div className="px-4 pb-4">
            ...
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">What platforms does ACME payment gateway support?</summary>
            ...
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">Does ACME provide international payments support?</summary>
              <div className="px-4 pb-4 space-y-2">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut voluptates aspernatur dolores in consequatur doloremque inventore reprehenderit, consequuntur perspiciatis architecto.</p>
                <p>Sed consectetur quod tenetur! Voluptatibus culpa incidunt veritatis velit quasi cupiditate unde eaque! Iure, voluptatibus autem eaque unde possimus quae.</p>
              </div>
            ...
            <details>
              <summary className="py-2 outline-none cursor-pointer focus:underline">Is there any setup fee or annual maintainance fee that I need to pay regularly?</summary>
              <div className="px-4 pb-4 space-y-2">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut voluptates aspernatur dolores in consequatur doloremque inventore reprehenderit, consequuntur perspiciatis architecto.</p>
                <p>Sed consectetur quod tenetur! Voluptatibus culpa incidunt veritatis velit quasi cupiditate unde eaque! Iure, voluptatibus autem eaque unde possimus quae.</p>
              </div>
